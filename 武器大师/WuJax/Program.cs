...
namespace WuJax
{
    static class Program
    {
        ...
        static void OnLoadingComplete(EventArgs args)
        {
            ...
            Menu = MainMenu.AddMenu("武器大师" + CN, "武器大师" + CN);

            //------------------------------Combo-------------------------------

            Menu.AddGroupLabel("连招");
            {
                Menu.Add("UseQCombo", new CheckBox("使用Q"));
                Menu.Add("QOnDash", new CheckBox("当敌人逃跑使用Q!"));
                Menu.Add("QDelayCombo", new Slider("使用E，然后跳过去的延迟 (1000 ms = 1 秒):", 1500, 0, 1900));
                Menu.Add("UseWCombo", new CheckBox("使用 W"));
                Menu.Add("UseWAARCombo", new CheckBox("使用W重置普攻"));
                Menu.Add("UseECombo", new CheckBox("使用 E"));
                Menu.Add("UseRCombo", new CheckBox("使用 R"));
                Menu.Add("Use1v1RLogic", new CheckBox("使用 1v1 R 逻辑"));
                Menu.Add("Min Enemies R", new Slider("使用R当敌人不少于：", 2, 1, 5));
            }
            Menu.AddSeparator();
            ...
            Menu.AddGroupLabel("骚扰");
            {
                ...
                Menu.Add("QDelayHarass", new Slider("使用E，然后跳过去的延迟 (1000 ms = 1 秒):", 1500, 0, 1900));
                Menu.Add("UseWHarass", new CheckBox("使用 W"));
                Menu.Add("UseWAARHarass", new CheckBox("使用W重置普攻"));
                Menu.Add("UseEHarass", new CheckBox("使用 E"));
                Menu.Add("Harass, Mana %", new Slider("蓝量控制 %", 30, 1, 100));
            }
            Menu.AddSeparator();
            ...
            Menu.AddGroupLabel("清兵");
            {
                Menu.Add("UseQLaneClear", new CheckBox("使用 Q"));
                Menu.Add("JustQIMWD", new CheckBox("使用Q，仅在小兵可以Q死的时候"));
                Menu.Add("UseWLaneClear", new CheckBox("使用W"));
                Menu.Add("UseELaneClear", new CheckBox("使用E"));
                Menu.Add("Min Minions E", new Slider("使用E最少小兵数", 3, 1, 10));
                Menu.Add("LaneClear, Mana %", new Slider("蓝量控制 %", 30, 1, 100));
            }
            Menu.AddSeparator();
            ...
            {
                Menu.Add("UseQJungleClear", new CheckBox("使用 Q"));
                Menu.Add("UseWJungleClear", new CheckBox("使用 W"));
                Menu.Add("UseEJungleClear", new CheckBox("使用 E"));
                Menu.Add("JungleClear, Mana %", new Slider("蓝量控制 %", 30, 1, 100));
            }
            Menu.AddSeparator();

            //------------------------------Smite Usage-------------------------------

            Menu.AddGroupLabel("惩戒设置");
            {
                Menu.Add("Use Smite?", new CheckBox("使用惩戒?"));
                Menu.AddSeparator();
                Menu.Add("Red?", new CheckBox("红BUFF?"));
                Menu.Add("Blue?", new CheckBox("蓝BUFF?"));
                Menu.Add("Wolf?", new CheckBox("狼?"));
                Menu.Add("Gromp?", new CheckBox("癞蛤蟆?"));
                Menu.Add("Raptor?", new CheckBox("最大的鸟?"));
                Menu.Add("Krug?", new CheckBox("石头怪?"));
            }
            Menu.AddSeparator();

            //------------------------------Drawings-------------------------------

            Menu.AddGroupLabel("显示设置");
            {
                Menu.Add("DrawQ", new CheckBox("画出 Q"));
                Menu.Add("DrawE", new CheckBox("画出 E"));
                if (Smite != null) Menu.Add("DrawSmite", new CheckBox("画出惩戒范围"));
                Menu.Add("ComboDamage on HPBar", new CheckBox("在敌人血条上显示伤害"));
            }
            Menu.AddSeparator();
            ...
            Menu.Add("KS", new CheckBox("抢人头"));
            Menu.Add("Auto Ignite", new CheckBox("自动惩戒"));
            Menu.Add("WardJump", new KeyBind("一键跳眼", false, KeyBind.BindTypes.HoldActive, 'T'));
        ...
        static void Game_OnTick(EventArgs args)
        {
            ...
            if (Menu["KS"].Cast<CheckBox>().CurrentValue) Modes.KS();
        ...
        class Modes
        {
            ...
            public static void KS()
            {
                ...
                if (Q.IsReady() && W.IsReady())
                {
                    ...
                    if (bye != null) { W.Cast(); Core.DelayAction(() => Q.Cast(bye), Game.Ping + 100); return; }
                }
